...
class _OnboardingState extends State<Onboarding> {
  ...
  final List<Color> pageColors = [const Color.fromARGB(255, 107, 194, 110)];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          ...
          if (index == _currentPage + 5) {
            _goToNextPage();
          } else if (index == _currentPage - 5) {
...
final List<Map<String, String>> onboardingData = [
  {
    ...
    'image': 'lib/assets/image/pic1.png',
  },
  {
    'text': 'Find what you need\nEasily search and browse through categories.',
    'image': 'lib/assets/image/pic2.png',
  },
  {
    'text': 'Fast and Secure\nEnjoy a fast and secure shopping experience.',
    'image': 'lib/assets/image/pic3.png',
  },
  {
    'text': 'Get Started\nSign up and start exploring our app now!',
    'image': 'lib/assets/image/pic4.png',
  },
  {
    'text': 'Available now\nPlease enjoy our app Thx!',
    'image': 'lib/assets/image/pic5.png',
  },
];